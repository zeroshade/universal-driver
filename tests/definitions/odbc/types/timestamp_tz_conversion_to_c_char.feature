@odbc
Feature: ODBC TIMESTAMP_TZ to SQL_C_CHAR conversions

  @odbc_e2e
  Scenario: TIMESTAMP_TZ to SQL_C_CHAR
    Given Snowflake client is logged in
    When TIMESTAMP_TZ values are fetched as SQL_C_CHAR
    Then String representation matches UTC time

  @odbc_e2e
  Scenario: TIMESTAMP_TZ to SQL_C_CHAR fractional truncation
    Given Snowflake client is logged in
