@odbc
Feature: ODBC TIMESTAMP_LTZ incompatible C type conversions
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_LTZ to numeric C types
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_LTZ to additional numeric C types
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_LTZ" is executed
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_LTZ to single-component interval C types
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_LTZ" is executed
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_LTZ to compound interval C types
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_LTZ" is executed
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_LTZ to SQL_C_GUID
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_LTZ" is executed
