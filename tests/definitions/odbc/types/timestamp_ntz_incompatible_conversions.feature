@odbc
Feature: ODBC TIMESTAMP_NTZ incompatible C type conversions
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_NTZ to numeric C types
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_NTZ to additional numeric C types
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_NTZ" is executed
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_NTZ to single-component interval C types
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_NTZ" is executed
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_NTZ to compound interval C types
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_NTZ" is executed
  ...
  @odbc_e2e
  Scenario: should fail converting TIMESTAMP_NTZ to SQL_C_GUID
    Given Snowflake client is logged in
    When Query "SELECT '2024-01-15 14:30:45'::TIMESTAMP_NTZ" is executed
