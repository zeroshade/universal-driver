...
class IntervalDayTimeConverterInt : public IColumnConverter {
 public:
  explicit IntervalDayTimeConverterInt(ArrowArrayView* array, PyObject* context, bool useNumpy);
...
class IntervalDayTimeConverterDecimal : public IColumnConverter {
 public:
  explicit IntervalDayTimeConverterDecimal(ArrowArrayView* array, PyObject* context, bool useNumpy);
