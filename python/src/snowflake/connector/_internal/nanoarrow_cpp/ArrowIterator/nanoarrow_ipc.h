...
/// NANOARROW_OK otherwise.
ArrowErrorCode ArrowIpcDecoderDecodeSchema(struct ArrowIpcDecoder* decoder, struct ArrowSchema* out,
...
ArrowErrorCode ArrowIpcDecoderSetSchema(struct ArrowIpcDecoder* decoder, struct ArrowSchema* schema,
                                        struct ArrowError* error);
...
struct ArrowIpcInputStream {
  ...
  ArrowErrorCode (*read)(struct ArrowIpcInputStream* stream, uint8_t* buf, int64_t buf_size_bytes,
