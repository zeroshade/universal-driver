...
static inline void flatcc_emitter_init(flatcc_emitter_t* E) { memset(E, 0, sizeof(*E)); }
 ...
 */
static inline size_t flatcc_emitter_get_buffer_size(flatcc_emitter_t* E) { return E->used; }
