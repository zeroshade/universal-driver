...
#define FLATCC_VERIFY_ERROR_MAP(XX)                                                              \
  ...
  XX(type_field_absent_from_required_union_vector_field,                                         \
     "type field absent from required union vector field")                                       \
  ...
  XX(vector_count_exceeds_representable_vector_size,                                             \
     "vector count exceeds representable vector size")                                           \
...
int flatcc_verify_field(flatcc_table_verifier_descriptor_t* td, flatbuffers_voffset_t id,
                        size_t size, uint16_t align);
/* Vector of scalars, enums or structs. */
int flatcc_verify_vector_field(flatcc_table_verifier_descriptor_t* td, flatbuffers_voffset_t id,
                               int required, size_t elem_size, uint16_t align, size_t max_count);
int flatcc_verify_string_field(flatcc_table_verifier_descriptor_t* td, flatbuffers_voffset_t id,
                               int required);
int flatcc_verify_string_vector_field(flatcc_table_verifier_descriptor_t* td,
                                      flatbuffers_voffset_t id, int required);
int flatcc_verify_table_field(flatcc_table_verifier_descriptor_t* td, flatbuffers_voffset_t id,
 ...
 */
int flatcc_verify_union_field(flatcc_table_verifier_descriptor_t* td, flatbuffers_voffset_t id,
                              int required, flatcc_union_verifier_f uvf);
