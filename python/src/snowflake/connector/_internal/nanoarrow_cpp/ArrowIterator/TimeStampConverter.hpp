...
class OneFieldTimeStampNTZConverter : public TimeStampBaseConverter {
 public:
  explicit OneFieldTimeStampNTZConverter(ArrowArrayView* array, int32_t scale, PyObject* context);
...
class OneFieldTimeStampLTZConverter : public TimeStampBaseConverter {
 public:
  explicit OneFieldTimeStampLTZConverter(ArrowArrayView* array, int32_t scale, PyObject* context);
