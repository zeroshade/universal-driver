...
namespace sf {
Logger* FixedSizeListConverter::logger = new Logger("snowflake.connector.FixedSizeListConverter");

FixedSizeListConverter::FixedSizeListConverter(ArrowArrayView* array) : m_array(array) {}
