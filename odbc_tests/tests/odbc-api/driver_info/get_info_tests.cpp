...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_GETDATA_EXTENSIONS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((getdataExt & SQL_GD_ANY_COLUMN) ==
          SQL_GD_ANY_COLUMN);  // Reference driver supports SQLGetData for any unbound column
  REQUIRE((getdataExt & SQL_GD_ANY_ORDER) ==
          SQL_GD_ANY_ORDER);  // Reference driver supports SQLGetData for unbound columns in any order
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_INFO_SCHEMA_VIEWS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((infoSchemaViews & SQL_ISV_REFERENTIAL_CONSTRAINTS) ==
          SQL_ISV_REFERENTIAL_CONSTRAINTS);  // Reference driver supports REFERENTIAL_CONSTRAINTS view
  ...
  REQUIRE((infoSchemaViews & SQL_ISV_TABLE_CONSTRAINTS) ==
          SQL_ISV_TABLE_CONSTRAINTS);  // Reference driver supports TABLE_CONSTRAINTS view
  REQUIRE((infoSchemaViews & SQL_ISV_TABLE_PRIVILEGES) ==
          SQL_ISV_TABLE_PRIVILEGES);                              // Reference driver supports TABLE_PRIVILEGES view
  ...
  REQUIRE((infoSchemaViews & SQL_ISV_USAGE_PRIVILEGES) ==
          SQL_ISV_USAGE_PRIVILEGES);  // Reference driver supports USAGE_PRIVILEGES view
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_ODBC_INTERFACE_CONFORMANCE",
  ...
  ret = SQLGetInfo(dbc_handle(), SQL_ODBC_INTERFACE_CONFORMANCE, &interfaceConformance, sizeof(interfaceConformance),
                   nullptr);
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_DEFAULT_TXN_ISOLATION", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((txnIsolation & SQL_TXN_READ_COMMITTED) ==
          SQL_TXN_READ_COMMITTED);  // Reference driver default is READ COMMITTED
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SCROLL_OPTIONS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((scrollOpts & SQL_SO_FORWARD_ONLY) ==
          SQL_SO_FORWARD_ONLY);  // Reference driver supports forward-only scrolling
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_TXN_ISOLATION_OPTION", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((txnIsoOpts & SQL_TXN_READ_COMMITTED) ==
          SQL_TXN_READ_COMMITTED);  // Reference driver supports READ COMMITTED isolation
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_ALTER_TABLE", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((alterTable & SQL_AT_ADD_COLUMN_DEFAULT) ==
          SQL_AT_ADD_COLUMN_DEFAULT);  // Reference driver supports adding columns with defaults
  REQUIRE((alterTable & SQL_AT_ADD_COLUMN_SINGLE) ==
          SQL_AT_ADD_COLUMN_SINGLE);  // Reference driver supports adding single columns
  REQUIRE((alterTable & SQL_AT_ADD_CONSTRAINT) == 0);
  REQUIRE((alterTable & SQL_AT_ADD_TABLE_CONSTRAINT) ==
          SQL_AT_ADD_TABLE_CONSTRAINT);  // Reference driver supports adding table constraints
  REQUIRE((alterTable & SQL_AT_CONSTRAINT_NAME_DEFINITION) ==
          SQL_AT_CONSTRAINT_NAME_DEFINITION);  // Reference driver supports naming constraints
  REQUIRE((alterTable & SQL_AT_DROP_COLUMN_CASCADE) ==
          SQL_AT_DROP_COLUMN_CASCADE);  // Reference driver supports DROP COLUMN CASCADE
  REQUIRE((alterTable & SQL_AT_DROP_COLUMN_DEFAULT) ==
          SQL_AT_DROP_COLUMN_DEFAULT);  // Reference driver supports altering column defaults (drop)
  REQUIRE((alterTable & SQL_AT_DROP_COLUMN_RESTRICT) ==
          SQL_AT_DROP_COLUMN_RESTRICT);  // Reference driver supports DROP COLUMN RESTRICT
  REQUIRE((alterTable & SQL_AT_DROP_TABLE_CONSTRAINT_CASCADE) ==
          SQL_AT_DROP_TABLE_CONSTRAINT_CASCADE);  // Reference driver supports DROP TABLE CONSTRAINT CASCADE
  REQUIRE((alterTable & SQL_AT_DROP_TABLE_CONSTRAINT_RESTRICT) ==
          SQL_AT_DROP_TABLE_CONSTRAINT_RESTRICT);  // Reference driver supports DROP TABLE CONSTRAINT RESTRICT
  REQUIRE((alterTable & SQL_AT_SET_COLUMN_DEFAULT) == 0);
  REQUIRE((alterTable & SQL_AT_CONSTRAINT_INITIALLY_DEFERRED) ==
          SQL_AT_CONSTRAINT_INITIALLY_DEFERRED);  // Reference driver supports initially deferred constraints
  REQUIRE((alterTable & SQL_AT_CONSTRAINT_INITIALLY_IMMEDIATE) ==
          SQL_AT_CONSTRAINT_INITIALLY_IMMEDIATE);  // Reference driver supports initially immediate constraints
  REQUIRE((alterTable & SQL_AT_CONSTRAINT_DEFERRABLE) ==
          SQL_AT_CONSTRAINT_DEFERRABLE);  // Reference driver supports deferrable constraints
  REQUIRE((alterTable & SQL_AT_CONSTRAINT_NON_DEFERRABLE) ==
          SQL_AT_CONSTRAINT_NON_DEFERRABLE);  // Reference driver supports non-deferrable constraints
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CATALOG_USAGE", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((catUsage & SQL_CU_DML_STATEMENTS) ==
          SQL_CU_DML_STATEMENTS);  // Reference driver supports catalogs in DML statements
  REQUIRE((catUsage & SQL_CU_PROCEDURE_INVOCATION) == 0);
  REQUIRE((catUsage & SQL_CU_TABLE_DEFINITION) ==
          SQL_CU_TABLE_DEFINITION);  // Reference driver supports catalogs in table definition statements
  REQUIRE((catUsage & SQL_CU_INDEX_DEFINITION) == 0);
  REQUIRE((catUsage & SQL_CU_PRIVILEGE_DEFINITION) ==
          SQL_CU_PRIVILEGE_DEFINITION);  // Reference driver supports catalogs in privilege definition statements
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CREATE_SCHEMA", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((create & SQL_CS_CREATE_SCHEMA) ==
          SQL_CS_CREATE_SCHEMA);  // Reference driver supports CREATE SCHEMA statement
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CREATE_TABLE", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((create & SQL_CT_TABLE_CONSTRAINT) ==
          SQL_CT_TABLE_CONSTRAINT);  // Reference driver supports specifying table constraints
  REQUIRE((create & SQL_CT_CONSTRAINT_NAME_DEFINITION) ==
          SQL_CT_CONSTRAINT_NAME_DEFINITION);  // Reference driver supports naming column and table constraints
  ...
  REQUIRE((create & SQL_CT_COLUMN_CONSTRAINT) ==
          SQL_CT_COLUMN_CONSTRAINT);  // Reference driver supports specifying column constraints
  REQUIRE((create & SQL_CT_COLUMN_DEFAULT) == 0);
  REQUIRE((create & SQL_CT_COLUMN_COLLATION) == 0);
  REQUIRE((create & SQL_CT_CONSTRAINT_INITIALLY_DEFERRED) ==
          SQL_CT_CONSTRAINT_INITIALLY_DEFERRED);  // Reference driver supports initially deferred constraints
  REQUIRE((create & SQL_CT_CONSTRAINT_INITIALLY_IMMEDIATE) ==
          SQL_CT_CONSTRAINT_INITIALLY_IMMEDIATE);  // Reference driver supports initially immediate constraints
  REQUIRE((create & SQL_CT_CONSTRAINT_DEFERRABLE) ==
          SQL_CT_CONSTRAINT_DEFERRABLE);  // Reference driver supports deferrable constraints
  REQUIRE((create & SQL_CT_CONSTRAINT_NON_DEFERRABLE) ==
          SQL_CT_CONSTRAINT_NON_DEFERRABLE);  // Reference driver supports non-deferrable constraints
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_GROUP_BY", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE(ret == SQL_SUCCESS);
  REQUIRE(groupBy ==
          SQL_GB_GROUP_BY_CONTAINS_SELECT);  // Reference driver supports GROUP BY with expressions not in SELECT list
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_INSERT_STATEMENT", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((insertStmt & SQL_IS_INSERT_LITERALS) ==
          SQL_IS_INSERT_LITERALS);  // Reference driver supports INSERT with literals
  REQUIRE((insertStmt & SQL_IS_INSERT_SEARCHED) ==
          SQL_IS_INSERT_SEARCHED);  // Reference driver supports INSERT with searched values
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SCHEMA_USAGE", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((schemaUsage & SQL_SU_DML_STATEMENTS) ==
          SQL_SU_DML_STATEMENTS);  // Reference driver supports schemas in DML statements
  REQUIRE((schemaUsage & SQL_SU_PROCEDURE_INVOCATION) == 0);
  REQUIRE((schemaUsage & SQL_SU_TABLE_DEFINITION) ==
          SQL_SU_TABLE_DEFINITION);  // Reference driver supports schemas in table definition statements
  REQUIRE((schemaUsage & SQL_SU_INDEX_DEFINITION) == 0);
  REQUIRE((schemaUsage & SQL_SU_PRIVILEGE_DEFINITION) ==
          SQL_SU_PRIVILEGE_DEFINITION);  // Reference driver supports schemas in privilege definition statements
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SPECIAL_CHARACTERS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE(ret == SQL_SUCCESS);
  REQUIRE(specialCharsLen ==
          0);  // Reference driver does not have any special characters beyond the SQL-92 reserved characters
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SUBQUERIES", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((subqueries & SQL_SQ_CORRELATED_SUBQUERIES) ==
          SQL_SQ_CORRELATED_SUBQUERIES);  // Reference driver supports correlated subqueries
  REQUIRE((subqueries & SQL_SQ_COMPARISON) ==
          SQL_SQ_COMPARISON);  // Reference driver supports subqueries in comparison predicates
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SQL92_GRANT", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((grantSupport & SQL_SG_DELETE_TABLE) ==
          SQL_SG_DELETE_TABLE);  // Reference driver supports GRANT DELETE on tables
  REQUIRE((grantSupport & SQL_SG_INSERT_COLUMN) == 0);
  REQUIRE((grantSupport & SQL_SG_INSERT_TABLE) ==
          SQL_SG_INSERT_TABLE);  // Reference driver supports GRANT INSERT on tables
  REQUIRE((grantSupport & SQL_SG_REFERENCES_TABLE) ==
          SQL_SG_REFERENCES_TABLE);  // Reference driver supports GRANT REFERENCES on tables
  REQUIRE((grantSupport & SQL_SG_REFERENCES_COLUMN) == 0);
  REQUIRE((grantSupport & SQL_SG_SELECT_TABLE) ==
          SQL_SG_SELECT_TABLE);  // Reference driver supports GRANT SELECT on tables
  REQUIRE((grantSupport & SQL_SG_UPDATE_COLUMN) == 0);
  REQUIRE((grantSupport & SQL_SG_UPDATE_TABLE) ==
          SQL_SG_UPDATE_TABLE);  // Reference driver supports GRANT UPDATE on tables
  ...
  REQUIRE((grantSupport & SQL_SG_WITH_GRANT_OPTION) ==
          SQL_SG_WITH_GRANT_OPTION);  // Reference driver supports GRANT WITH GRANT OPTION
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SQL92_PREDICATES", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((preds & SQL_SP_QUANTIFIED_COMPARISON) ==
          SQL_SP_QUANTIFIED_COMPARISON);              // Reference driver supports quantified comparison predicates
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SQL92_RELATIONAL_JOIN_OPERATORS",
  ...
  REQUIRE((joinOps & SQL_SRJO_FULL_OUTER_JOIN) ==
          SQL_SRJO_FULL_OUTER_JOIN);                                // Reference driver supports FULL OUTER JOIN
  ...
  REQUIRE((joinOps & SQL_SRJO_LEFT_OUTER_JOIN) ==
          SQL_SRJO_LEFT_OUTER_JOIN);  // Reference driver supports LEFT OUTER JOIN
  REQUIRE((joinOps & SQL_SRJO_NATURAL_JOIN) == 0);
  REQUIRE((joinOps & SQL_SRJO_RIGHT_OUTER_JOIN) ==
          SQL_SRJO_RIGHT_OUTER_JOIN);  // Reference driver supports RIGHT OUTER JOIN
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SQL92_REVOKE", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((revokeSupport & SQL_SR_DELETE_TABLE) ==
          SQL_SR_DELETE_TABLE);  // Reference driver supports REVOKE DELETE on tables
  REQUIRE((revokeSupport & SQL_SR_GRANT_OPTION_FOR) ==
          SQL_SR_GRANT_OPTION_FOR);  // Reference driver supports REVOKE GRANT OPTION FOR
  REQUIRE((revokeSupport & SQL_SR_INSERT_COLUMN) == 0);
  REQUIRE((revokeSupport & SQL_SR_INSERT_TABLE) ==
          SQL_SR_INSERT_TABLE);  // Reference driver supports REVOKE INSERT on tables
  REQUIRE((revokeSupport & SQL_SR_REFERENCES_COLUMN) == 0);
  REQUIRE((revokeSupport & SQL_SR_REFERENCES_TABLE) ==
          SQL_SR_REFERENCES_TABLE);  // Reference driver supports REVOKE REFERENCES on tables
  REQUIRE((revokeSupport & SQL_SR_RESTRICT) == SQL_SR_RESTRICT);  // Reference driver supports REVOKE with RESTRICT
  REQUIRE((revokeSupport & SQL_SR_SELECT_TABLE) ==
          SQL_SR_SELECT_TABLE);  // Reference driver supports REVOKE SELECT on tables
  REQUIRE((revokeSupport & SQL_SR_UPDATE_COLUMN) == 0);
  REQUIRE((revokeSupport & SQL_SR_UPDATE_TABLE) ==
          SQL_SR_UPDATE_TABLE);  // Reference driver supports REVOKE UPDATE on tables
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SQL92_ROW_VALUE_CONSTRUCTOR",
  ...
  REQUIRE((rowValConstr & SQL_SRVC_VALUE_EXPRESSION) ==
          SQL_SRVC_VALUE_EXPRESSION);  // Reference driver supports value expressions in row value constructors
  REQUIRE((rowValConstr & SQL_SRVC_NULL) == SQL_SRVC_NULL);  // Reference driver supports NULL in row value constructors
  REQUIRE((rowValConstr & SQL_SRVC_DEFAULT) ==
          SQL_SRVC_DEFAULT);  // Reference driver supports DEFAULT in row value constructors
  REQUIRE((rowValConstr & SQL_SRVC_ROW_SUBQUERY) ==
          SQL_SRVC_ROW_SUBQUERY);  // Reference driver supports row subqueries in row value constructors
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_MAX_TABLES_IN_SELECT", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE(ret == SQL_SUCCESS);
  REQUIRE(maxTables == 0);  // No specified limit or unknown, reference driver does not have a specific limit on number
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_MAX_USER_NAME_LEN", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE(ret == SQL_SUCCESS);
  REQUIRE(maxUserLen ==
          0);  // No specified limit or unknown, reference driver does not have a specific limit on user name length
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_STRING_FUNCTIONS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((strFuncs & SQL_FN_STR_BIT_LENGTH) ==
          SQL_FN_STR_BIT_LENGTH);                            // Reference driver supports BIT_LENGTH function
  REQUIRE((strFuncs & SQL_FN_STR_CHAR) == SQL_FN_STR_CHAR);  // Reference driver supports CHAR function
  REQUIRE((strFuncs & SQL_FN_STR_CHAR_LENGTH) ==
          SQL_FN_STR_CHAR_LENGTH);  // Reference driver supports CHAR_LENGTH function
  REQUIRE((strFuncs & SQL_FN_STR_CHARACTER_LENGTH) ==
          SQL_FN_STR_CHARACTER_LENGTH);                          // Reference driver supports CHARACTER_LENGTH function
  ...
  REQUIRE((strFuncs & SQL_FN_STR_OCTET_LENGTH) ==
          SQL_FN_STR_OCTET_LENGTH);                                  // Reference driver supports OCTET_LENGTH function
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_TIMEDATE_ADD_INTERVALS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((intervals & SQL_FN_TSI_FRAC_SECOND) ==
          SQL_FN_TSI_FRAC_SECOND);  // Reference driver supports fractional seconds interval
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_TIMEDATE_FUNCTIONS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((timedateFuncs & SQL_FN_TD_CURRENT_DATE) ==
          SQL_FN_TD_CURRENT_DATE);  // Reference driver supports CURRENT_DATE function
  REQUIRE((timedateFuncs & SQL_FN_TD_CURRENT_TIME) ==
          SQL_FN_TD_CURRENT_TIME);  // Reference driver supports CURRENT_TIME function
  REQUIRE((timedateFuncs & SQL_FN_TD_CURRENT_TIMESTAMP) ==
          SQL_FN_TD_CURRENT_TIMESTAMP);  // Reference driver supports CURRENT_TIMESTAMP function
  ...
  REQUIRE((timedateFuncs & SQL_FN_TD_DAYOFMONTH) ==
          SQL_FN_TD_DAYOFMONTH);  // Reference driver supports DAYOFMONTH function
  REQUIRE((timedateFuncs & SQL_FN_TD_DAYOFWEEK) ==
          SQL_FN_TD_DAYOFWEEK);  // Reference driver supports DAYOFWEEK function
  REQUIRE((timedateFuncs & SQL_FN_TD_DAYOFYEAR) ==
          SQL_FN_TD_DAYOFYEAR);                                       // Reference driver supports DAYOFYEAR function
  ...
  REQUIRE((timedateFuncs & SQL_FN_TD_MONTHNAME) ==
          SQL_FN_TD_MONTHNAME);                                       // Reference driver supports MONTHNAME function
  ...
  REQUIRE((timedateFuncs & SQL_FN_TD_TIMESTAMPADD) ==
          SQL_FN_TD_TIMESTAMPADD);  // Reference driver supports TIMESTAMPADD function
  REQUIRE((timedateFuncs & SQL_FN_TD_TIMESTAMPDIFF) ==
          SQL_FN_TD_TIMESTAMPDIFF);                             // Reference driver supports TIMESTAMPDIFF function
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_SQL92_DATETIME_FUNCTIONS", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((funcs & SQL_SDF_CURRENT_TIMESTAMP) ==
          SQL_SDF_CURRENT_TIMESTAMP);  // Reference driver supports CURRENT_TIMESTAMP
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_BIGINT", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports BIGINT to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports BIGINT to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports BIGINT to LONGVARCHAR conversion
  ...
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports BIGINT to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_BINARY", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports BINARY to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_BIT", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) == 0);
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) ==
          SQL_CVT_LONGVARBINARY);  // Reference driver supports BIT to LONGVARBINARY conversion
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);                               // Reference driver supports BIT to LONGVARCHAR conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_CHAR", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);                               // Reference driver supports CHAR to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) == SQL_CVT_TINYINT);  // Reference driver supports CHAR to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports CHAR to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_DATE", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_TIME) == 0);
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);  // Reference driver supports DATE to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) == 0);
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_GUID", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports GUID to LONGVARCHAR conversion
  REQUIRE((convert & SQL_CVT_NUMERIC) == 0);
  REQUIRE((convert & SQL_CVT_REAL) == 0);
  REQUIRE((convert & SQL_CVT_SMALLINT) == 0);
  REQUIRE((convert & SQL_CVT_TIME) == 0);
  ...
  REQUIRE((convert & SQL_CVT_TINYINT) == 0);
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports GUID to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_INTERVAL_DAY_TIME",
  ...
  REQUIRE((convert & SQL_CVT_BIGINT) ==
          SQL_CVT_BIGINT);  // Reference driver supports INTERVAL_DAY_TIME to BIGINT conversion
  REQUIRE((convert & SQL_CVT_BINARY) ==
          SQL_CVT_BINARY);  // Reference driver supports INTERVAL_DAY_TIME to BINARY conversion
  REQUIRE((convert & SQL_CVT_BIT) == 0);
  REQUIRE((convert & SQL_CVT_CHAR) == SQL_CVT_CHAR);  // Reference driver supports INTERVAL_DAY_TIME to CHAR conversion
  REQUIRE((convert & SQL_CVT_DATE) == 0);
  REQUIRE((convert & SQL_CVT_DECIMAL) ==
          SQL_CVT_DECIMAL);  // Reference driver supports INTERVAL_DAY_TIME to DECIMAL conversion
  REQUIRE((convert & SQL_CVT_DOUBLE) == 0);
  REQUIRE((convert & SQL_CVT_FLOAT) == 0);
  REQUIRE((convert & SQL_CVT_GUID) == 0);
  REQUIRE((convert & SQL_CVT_INTEGER) ==
          SQL_CVT_INTEGER);  // Reference driver supports INTERVAL_DAY_TIME to INTEGER conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) == 0);
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports INTERVAL_DAY_TIME to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports INTERVAL_DAY_TIME to LONGVARCHAR conversion
  REQUIRE((convert & SQL_CVT_NUMERIC) ==
          SQL_CVT_NUMERIC);  // Reference driver supports INTERVAL_DAY_TIME to NUMERIC conversion
  REQUIRE((convert & SQL_CVT_REAL) == 0);
  REQUIRE((convert & SQL_CVT_SMALLINT) ==
          SQL_CVT_SMALLINT);  // Reference driver supports INTERVAL_DAY_TIME to SMALLINT conversion
  REQUIRE((convert & SQL_CVT_TIME) == 0);
  REQUIRE((convert & SQL_CVT_TIMESTAMP) == 0);
  REQUIRE((convert & SQL_CVT_TINYINT) ==
          SQL_CVT_TINYINT);  // Reference driver supports INTERVAL_DAY_TIME to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);  // Reference driver supports INTERVAL_DAY_TIME to VARBINARY conversion
  REQUIRE((convert & SQL_CVT_VARCHAR) ==
          SQL_CVT_VARCHAR);  // Reference driver supports INTERVAL_DAY_TIME to VARCHAR conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_INTERVAL_YEAR_MONTH",
  ...
  REQUIRE((convert & SQL_CVT_BIGINT) ==
          SQL_CVT_BIGINT);  // Reference driver supports INTERVAL_YEAR_MONTH to BIGINT conversion
  REQUIRE((convert & SQL_CVT_BINARY) ==
          SQL_CVT_BINARY);  // Reference driver supports INTERVAL_YEAR_MONTH to BINARY conversion
  REQUIRE((convert & SQL_CVT_BIT) == 0);
  REQUIRE((convert & SQL_CVT_CHAR) ==
          SQL_CVT_CHAR);  // Reference driver supports INTERVAL_YEAR_MONTH to CHAR conversion
  REQUIRE((convert & SQL_CVT_DATE) == 0);
  REQUIRE((convert & SQL_CVT_DECIMAL) ==
          SQL_CVT_DECIMAL);  // Reference driver supports INTERVAL_YEAR_MONTH to DECIMAL conversion
  REQUIRE((convert & SQL_CVT_DOUBLE) == 0);
  REQUIRE((convert & SQL_CVT_FLOAT) == 0);
  REQUIRE((convert & SQL_CVT_GUID) == 0);
  REQUIRE((convert & SQL_CVT_INTEGER) ==
          SQL_CVT_INTEGER);  // Reference driver supports INTERVAL_YEAR_MONTH to INTEGER conversion
  REQUIRE(
      (convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
      SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports INTERVAL_YEAR_MONTH to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports INTERVAL_YEAR_MONTH to LONGVARCHAR conversion
  REQUIRE((convert & SQL_CVT_NUMERIC) ==
          SQL_CVT_NUMERIC);  // Reference driver supports INTERVAL_YEAR_MONTH to NUMERIC conversion
  REQUIRE((convert & SQL_CVT_REAL) == 0);
  REQUIRE((convert & SQL_CVT_SMALLINT) ==
          SQL_CVT_SMALLINT);  // Reference driver supports INTERVAL_YEAR_MONTH to SMALLINT conversion
  REQUIRE((convert & SQL_CVT_TIME) == 0);
  REQUIRE((convert & SQL_CVT_TIMESTAMP) == 0);
  REQUIRE((convert & SQL_CVT_TINYINT) ==
          SQL_CVT_TINYINT);  // Reference driver supports INTERVAL_YEAR_MONTH to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);  // Reference driver supports INTERVAL_YEAR_MONTH to VARBINARY conversion
  REQUIRE((convert & SQL_CVT_VARCHAR) ==
          SQL_CVT_VARCHAR);  // Reference driver supports INTERVAL_YEAR_MONTH to VARCHAR conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_LONGVARBINARY", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_BIGINT) == 0);
  REQUIRE((convert & SQL_CVT_BINARY) ==
          SQL_CVT_BINARY);  // Reference driver supports LONGVARBINARY to BINARY conversion
  REQUIRE((convert & SQL_CVT_BIT) == 0);
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) ==
          SQL_CVT_LONGVARBINARY);  // Reference driver supports LONGVARBINARY to LONGVARBINARY conversion
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports LONGVARBINARY to LONGVARCHAR conversion
  REQUIRE((convert & SQL_CVT_NUMERIC) == 0);
  REQUIRE((convert & SQL_CVT_REAL) == 0);
  REQUIRE((convert & SQL_CVT_SMALLINT) == 0);
  REQUIRE((convert & SQL_CVT_TIME) == 0);
  ...
  REQUIRE((convert & SQL_CVT_TINYINT) == 0);
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);  // Reference driver supports LONGVARBINARY to VARBINARY conversion
  REQUIRE((convert & SQL_CVT_VARCHAR) ==
          SQL_CVT_VARCHAR);  // Reference driver supports LONGVARBINARY to VARCHAR conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_LONGVARCHAR", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_DECIMAL) ==
          SQL_CVT_DECIMAL);                               // Reference driver supports LONGVARCHAR to DECIMAL conversion
  ...
  REQUIRE((convert & SQL_CVT_INTEGER) ==
          SQL_CVT_INTEGER);  // Reference driver supports LONGVARCHAR to INTEGER conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports LONGVARCHAR to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports LONGVARCHAR to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports LONGVARCHAR to LONGVARCHAR conversion
  REQUIRE((convert & SQL_CVT_NUMERIC) ==
          SQL_CVT_NUMERIC);                           // Reference driver supports LONGVARCHAR to NUMERIC conversion
  REQUIRE((convert & SQL_CVT_REAL) == SQL_CVT_REAL);  // Reference driver supports LONGVARCHAR to REAL conversion
  REQUIRE((convert & SQL_CVT_SMALLINT) ==
          SQL_CVT_SMALLINT);                          // Reference driver supports LONGVARCHAR to SMALLINT conversion
  REQUIRE((convert & SQL_CVT_TIME) == SQL_CVT_TIME);  // Reference driver supports LONGVARCHAR to TIME conversion
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);  // Reference driver supports LONGVARCHAR to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) ==
          SQL_CVT_TINYINT);  // Reference driver supports LONGVARCHAR to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_VARCHAR) ==
          SQL_CVT_VARCHAR);  // Reference driver supports LONGVARCHAR to VARCHAR conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_REAL", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports REAL to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports REAL to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);                             // Reference driver supports REAL to LONGVARCHAR conversion
  ...
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports REAL to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_SMALLINT", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports SMALLINT to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports SMALLINT to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports SMALLINT to LONGVARCHAR conversion
  ...
  REQUIRE((convert & SQL_CVT_SMALLINT) ==
          SQL_CVT_SMALLINT);  // Reference driver supports SMALLINT to SMALLINT conversion
  REQUIRE((convert & SQL_CVT_TIME) == 0);
  REQUIRE((convert & SQL_CVT_TIMESTAMP) == 0);
  REQUIRE((convert & SQL_CVT_TINYINT) == SQL_CVT_TINYINT);  // Reference driver supports SMALLINT to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);  // Reference driver supports SMALLINT to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_TIMESTAMP", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);  // Reference driver supports TIMESTAMP to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) == 0);
  REQUIRE((convert & SQL_CVT_VARBINARY) == 0);
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_TINYINT", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports TINYINT to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports TINYINT to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports TINYINT to LONGVARCHAR conversion
  ...
  REQUIRE((convert & SQL_CVT_SMALLINT) ==
          SQL_CVT_SMALLINT);  // Reference driver supports TINYINT to SMALLINT conversion
  REQUIRE((convert & SQL_CVT_TIME) == 0);
  REQUIRE((convert & SQL_CVT_TIMESTAMP) == 0);
  REQUIRE((convert & SQL_CVT_TINYINT) == SQL_CVT_TINYINT);  // Reference driver supports TINYINT to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports TINYINT to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_VARBINARY", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_TINYINT) == 0);
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);  // Reference driver supports VARBINARY to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_VARCHAR", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);  // Reference driver supports VARCHAR to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) == 0);
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports VARCHAR to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_WCHAR", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports WCHAR to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports WCHAR to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) ==
          SQL_CVT_LONGVARBINARY);  // Reference driver supports WCHAR to LONGVARBINARY conversion
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);                             // Reference driver supports WCHAR to LONGVARCHAR conversion
  ...
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);                               // Reference driver supports WCHAR to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) == SQL_CVT_TINYINT);  // Reference driver supports WCHAR to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);                               // Reference driver supports WCHAR to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_WVARCHAR", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports WVARCHAR to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports WVARCHAR to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) ==
          SQL_CVT_LONGVARBINARY);  // Reference driver supports WVARCHAR to LONGVARBINARY conversion
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports WVARCHAR to LONGVARCHAR conversion
  ...
  REQUIRE((convert & SQL_CVT_SMALLINT) ==
          SQL_CVT_SMALLINT);                          // Reference driver supports WVARCHAR to SMALLINT conversion
  REQUIRE((convert & SQL_CVT_TIME) == SQL_CVT_TIME);  // Reference driver supports WVARCHAR to TIME conversion
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);  // Reference driver supports WVARCHAR to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) == SQL_CVT_TINYINT);  // Reference driver supports WVARCHAR to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) ==
          SQL_CVT_VARBINARY);  // Reference driver supports WVARCHAR to VARBINARY conversion
...
TEST_CASE_METHOD(DbcDefaultDSNFixture, "SQLGetInfo: SQL_CONVERT_WLONGVARCHAR", "[odbc-api][getinfo][driver_info]") {
  ...
  REQUIRE((convert & SQL_CVT_DECIMAL) ==
          SQL_CVT_DECIMAL);  // Reference driver supports WLONGVARCHAR to DECIMAL conversion
  ...
  REQUIRE((convert & SQL_CVT_INTEGER) ==
          SQL_CVT_INTEGER);  // Reference driver supports WLONGVARCHAR to INTEGER conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_YEAR_MONTH) ==
          SQL_CVT_INTERVAL_YEAR_MONTH);  // Reference driver supports WLONGVARCHAR to INTERVAL_YEAR_MONTH conversion
  REQUIRE((convert & SQL_CVT_INTERVAL_DAY_TIME) ==
          SQL_CVT_INTERVAL_DAY_TIME);  // Reference driver supports WLONGVARCHAR to INTERVAL_DAY_TIME conversion
  REQUIRE((convert & SQL_CVT_LONGVARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_LONGVARCHAR) ==
          SQL_CVT_LONGVARCHAR);  // Reference driver supports WLONGVARCHAR to LONGVARCHAR conversion
  REQUIRE((convert & SQL_CVT_NUMERIC) ==
          SQL_CVT_NUMERIC);                           // Reference driver supports WLONGVARCHAR to NUMERIC conversion
  REQUIRE((convert & SQL_CVT_REAL) == SQL_CVT_REAL);  // Reference driver supports WLONGVARCHAR to REAL conversion
  REQUIRE((convert & SQL_CVT_SMALLINT) ==
          SQL_CVT_SMALLINT);                          // Reference driver supports WLONGVARCHAR to SMALLINT conversion
  REQUIRE((convert & SQL_CVT_TIME) == SQL_CVT_TIME);  // Reference driver supports WLONGVARCHAR to TIME conversion
  REQUIRE((convert & SQL_CVT_TIMESTAMP) ==
          SQL_CVT_TIMESTAMP);  // Reference driver supports WLONGVARCHAR to TIMESTAMP conversion
  REQUIRE((convert & SQL_CVT_TINYINT) ==
          SQL_CVT_TINYINT);  // Reference driver supports WLONGVARCHAR to TINYINT conversion
  REQUIRE((convert & SQL_CVT_VARBINARY) == 0);
  REQUIRE((convert & SQL_CVT_VARCHAR) ==
          SQL_CVT_VARCHAR);  // Reference driver supports WLONGVARCHAR to VARCHAR conversion
...
TEST_CASE("SQLGetInfo: SQL_INVALID_HANDLE - NULL connection handle", "[odbc-api][getinfo][driver_info][error]") {
  char buffer[256];
  const SQLRETURN ret = SQLGetInfo(SQL_NULL_HDBC, SQL_DBMS_NAME, buffer, sizeof(buffer), nullptr);
